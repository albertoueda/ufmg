...
void CollectionWriter::initialize() {
	...
	if(DEBUG) {
		cerr << "Writer Input Index File Name [" << inputIndexFileName_ << "]" << endl;
		cerr << "Writer Output Index File Name [" << outputIndexFileName_ << "]" << endl;
		cerr << "Writer Output Content File Name [" << outputPrefix.str() << "]" << endl;
		cerr << "Writer Initialization OK!" << endl;
	}
}
...
bool CollectionWriter::getNextDocument(Document & doc) {
	...
	//	clog << url << endl << inputContentFileName << endl << beginOffset << endl << endOffset << endl;
	...
	if(inputContentFileName_ == "") { // Reading first line in index
		...
		if(DEBUG) { cerr << "Writer: File [" << inputContentFileName_ << "] openned." << endl; }
	}
